...
def parse_args():
    ...
    parser.add_argument('--test-dir', type=str, default='./prediction')
    ...
    parser.add_argument('--new_accounts_test', type=str, default='test2.csv')
    ...
    parser.add_argument('--dropout', type=float, default=0.5, help='dropout probability, for gat only features')
